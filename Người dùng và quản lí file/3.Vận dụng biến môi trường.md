...
Biến **<mark>PATH</mark>** chứa 1 danh sách **":"** bởi các directory:
...
Nếu bash tìm tới cuối directory mà vẫn không tìm thấy giá trị thực thi. Nó sẽ hiện lên màn hình lỗi **<u>command not found</u>**
